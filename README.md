...
![Static Badge](https://img.shields.io/badge/node.js-grey?logo=nodedotjs) ![GitHub stars](https://img.shields.io/github/stars/TeraBap247/anime-api?logo=github)
![GitHub forks](https://img.shields.io/github/forks/TeraBap247/anime-api?logo=github)
...
<p align="center">RestFul API made with Node.js <br/>(Checkout this anime streaming website  <a href="https://zenime.site" tarGET="_blank">Xenime</a> powered by this API)</p>
...
```bash
$ git clone https://github.com/TeraBap247/anime-api.git
$ cd anime-api
$ npm install
```

2. Refer the [.env.example](https://github.com/TeraBap247/anime-api/blob/main/.env.example) file to setup `.env` file
...
[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/TeraBap247/anime-api)

### Render

Host your own instance of anime-api on Render.

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/TeraBap247/anime-api)
...
<p align="center" style="text-decoration: none;">Made by <a href="https://github.com/TeraBap247" tarGET="_blank">Team RXS 
</a>🫰</p>
